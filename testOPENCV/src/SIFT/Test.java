...
public static void main(String[] args) {
	...
	logo.readImage("/Users/Wendy/desktop/CS576_Project_Dataset_1/image028.rgb");
	searchImg.readImage("/Users/Wendy/desktop/CS576_Project_Dataset_3/image267.rgb"); 
	int cnt=0;
	for(int i=0; i<288; i++)
	   {
		for (int j=0; j<352; j++)
